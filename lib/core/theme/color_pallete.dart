...
abstract class ColorPallete {
  ...
  static const Color colorBlack = Color(0xFF121312);
  static const Color colorGradientDarkBlue = Color(0xFF084250);
  static const Color colorGradientDarkRed = Color(0xFF85210E);
